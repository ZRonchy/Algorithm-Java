...
// Given a string, find all palindrome permutations of it

public class FindAllPalindrome {
    public static void main(String[] args) {
        String str = "abbacdcabba";
        System.out.print(printAllPalindromes(str));
    }

    // Return total number of palindrome substring of
    // length greater than or equal to 2
    static int printAllPalindromes(String string) {
