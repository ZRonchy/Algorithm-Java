...
// and a positive integer s, find the minimal length of a contiguous subarray of
...
// We can use 2 pointers to mark the left and right boundaries of the sliding window.
