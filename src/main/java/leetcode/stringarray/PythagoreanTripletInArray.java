 ...
 * with given sum can be found in O(n) time using meet in middle algorithm discussed in
 * method 1 of this post. If no pair found for current ‘a’, then move ‘a’ one position
 * back and repeat step 3.2.
 */
